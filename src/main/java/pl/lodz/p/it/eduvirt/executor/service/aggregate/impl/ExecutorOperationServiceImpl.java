package pl.lodz.p.it.eduvirt.executor.service.aggregate.impl;
...
import pl.lodz.p.it.eduvirt.aspect.logging.InfoLoggerInterceptor;
...
public class ExecutorOperationServiceImpl implements ExecutorOperationService {
    ...
    @Override
    public void finalizePodReservation(ExecutorTask task) {
