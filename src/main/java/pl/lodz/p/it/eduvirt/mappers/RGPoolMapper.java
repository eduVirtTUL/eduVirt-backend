...
@Mapper(componentModel = "spring", uses = {CourseMapper.class, ResourceGroupMapper.class})
public interface RGPoolMapper {
    ...
    ResourceGroupPool toRGPool(UpdateResourceGroupPoolDto updateResourceGroupPoolDto);
}
