...
public class ExecutorTaskServiceImpl implements ExecutorTaskService {
    ...
    public List<ExecutorTask> getReservationsToEndTasks() {
        ...
        List<ExecutorTask> executorTasks = executorTaskRepository.findReservationsToEndTasks(currentTime.minusMinutes(vmShutdownGraceTime));

        executorTasks.forEach(executorTask -> forceReservationLazyCollections(executorTask.getReservation()));
